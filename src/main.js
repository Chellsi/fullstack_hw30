...
function isValidEmail(email) {
  ...
  // Більш строгий регулярний вираз для перевірки валідності електронної адреси
  const emailRegex = /^[a-zA-Z0-9]([a-zA-Z0-9._%-]*[a-zA-Z0-9])?@[a-zA-Z0-9]([a-zA-Z0-9.-]*[a-zA-Z0-9])?\.[a-zA-Z]{2,5}$/;
...
function isValidUrl(url) {
  ...
  // Строгий регулярний вираз для перевірки валідності URL (обов'язково з протоколом)
